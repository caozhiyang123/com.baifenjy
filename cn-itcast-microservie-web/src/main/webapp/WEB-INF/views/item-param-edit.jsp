...
<table cellpadding="5" style="margin-left: 30px" id="itemParamEditTable" class="itemParam">
	<tr>
		<td>商品类目:</td>
		<td>
			<a href="javascript:void(0)" class="easyui-linkbutton selectItemCat" disabled=true>选择类目</a>
		</td>
		<input type="hidden" name="cid" style="width:40px;">类目</input>
	</tr>
	<tr class="addGroupTr">
		<td>规格参数:</td>
		<td>
...
<script style="text/javascript">
	$(function(){
		...
		$("#itemParamEditTable .submit").click(function(){
			...
			var url = "/rest/item/param/update?itemCatId="+$("#itemParamEditTable [name=cid]").val();
